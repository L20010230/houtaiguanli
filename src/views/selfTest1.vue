    ...
    <div>
        ...
        <!-- <div class="await" style="padding:15px" v-show="testType == 1">
          <div class="components-container board">
            <Kanban :key="1" :list="list1" :group="group1" class="kanbanList" headerText='很不期待'/>
            <Kanban :key="2" :list="list2" :group="group2" class="kanbanList" headerText='不太期待'/>
            <Kanban :key="3" :list="list3" :group="group3" class="kanbanList" headerText='有点期待'/>
            <Kanban :key="4" :list="list4" :group="group4" class="kanbanList" headerText='完全期待' style="margin-right:0px"/>
          </div>
            <Kanban :key="5" :list="list5" :group="group5" class="kanbanSelect" headerText='所有职业'/>
        </div>  -->
        <!-- 调查问卷 自评-->
